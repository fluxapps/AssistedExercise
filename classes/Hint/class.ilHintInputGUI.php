...
class ilHintInputGUI extends ilFormPropertyGUI {
	...
	function __construct($a_title = "", $a_postvar = "") {
		...
		$btn_remove_hint->setCaption($this->obj_facade->getLanguageValue("text_remove_hint_btn"), false);
		...
		$DIC->ui()->mainTemplate()
			->addCss("./Customizing/global/plugins/Services/Repository/RepositoryObject/AssistedExercise/templates/default/less/hint_form.css");
	...
	function insert($a_tpl) {
		...
		if (!empty($this->getExistingHintData())) {
			foreach ($this->getExistingHintData() as $hint_data) {
				...
				if (!empty($this->getExistingLevelData()) && is_array($this->getExistingLevelData())) {
