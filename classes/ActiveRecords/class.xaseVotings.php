...
class xaseVotings {
	 ...
	 */
	public static function getUnvotedAnswersOfUser($assisted_exercise_object_id, $user_id) {
		global $ilDB;
	 ...
	 */
	public static function getBestVotedAnswerOfUser($assisted_exercise_object_id, $user_id) {
		global $ilDB;
		...
		$sql = "SELECT answer.* FROM ilias.rep_robj_xase_answer as answer
				...
				where 
			    item.assisted_exercise_id = ".$ilDB->quote($assisted_exercise_object_id,'integer');
